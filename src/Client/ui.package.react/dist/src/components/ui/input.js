...
export function Input(_a) {
    var _b;
    var { className, type, description, descriptionAlign = "left", clearable, errorMessage, errorDescription, maxLength, rightIcon, rightIconAction, value, onChange } = _a, props = __rest(_a, ["className", "type", "description", "descriptionAlign", "clearable", "errorMessage", "errorDescription", "maxLength", "rightIcon", "rightIconAction", "value", "onChange"]);
