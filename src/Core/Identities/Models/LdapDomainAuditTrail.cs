...
{
	public partial class LdapDomainAuditTrail : Core.Base.IBaseEntity, Core.Auditing.IAuditTrail, IEquatable<LdapDomainAuditTrail>
	{
		#region IBaseEntity
		...
		#region Clone 
		public virtual LdapDomainAuditTrail Clone()
		{
			LdapDomainAuditTrail clone = new();
			...
			clone.domainId = new string(domainId.ToCharArray());
			clone.domainName = new string(domainName.ToCharArray());
		...
		public bool Equals( LdapDomainAuditTrail other )
		{
		...
		public override bool Equals(object obj) => Equals(obj as LdapDomainAuditTrail);
